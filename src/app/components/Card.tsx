...
const FloatingImageContentBlock = () => {
    return(
        <section className="container mx-auto py-10 flex flex-col md:flex-row items-center">
            ...
            <h3 className="text-2xl font-semibold mt-6 mb-2 text-center text-white"> Coming Soon: Our New Burger Launches </h3>
            <ul>
                ...
                <li><strong>Mushroom Swiss Burger:</strong>
                 A Juicy beef patty melted Swiss cheese for a rich, savory taste.
                </li>
                <br/>
                <li><strong>Buffalo Chicken Burger:</strong>
                 A Crispy chicken breast tossed in spicy buffalo sauce.
                </li>
                <br/>
                <li><strong>Avacado Veggie Burger:</strong>
